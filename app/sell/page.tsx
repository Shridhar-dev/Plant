...
export default function Sell() {
  ...
  const updateFormData = async(e:ChangeEvent<HTMLInputElement | HTMLTextAreaElement> | string, type:string) => {
      ...
      <section className='px-20 py-10'>
        ...
        <div className='grid grid-cols-2 gap-5 mt-5'>
          <div className='flex flex-col gap-2'>
            ...
            <Input id="name" type="text" placeholder="Name"  onChange={(e)=>updateFormData(e,"name")}/>
            <label htmlFor='description' className='font-semibold mt-2'>Description</label>
            <Textarea id="description" placeholder="Add your description"  onChange={(e)=>updateFormData(e, "desc")}/>
            <label htmlFor='excerpt' className='font-semibold mt-2'>Excerpt</label>
            <Textarea id="excerpt" placeholder="Add your excerpt"  onChange={(e)=>updateFormData(e, "excerpt")}/>
            <div className='flex justify-between items-center gap-5 mt-2'>
              <div className='flex-1'>
                <label htmlFor='price' className='font-semibold'>Price</label>
                <Input id="price" type="text" placeholder="price"  onChange={(e)=>updateFormData(e, "price")}/>
              </div>
              <div className='flex-1'>
                <label htmlFor='category' className='font-semibold'>Category</label>
                <Select id='category'  onValueChange={(e:string)=>updateFormData(e, "category")}>
